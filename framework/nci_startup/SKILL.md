---
name: nci-startup
description: Use this skill when you are beginning a piece of work at NCI and do not yet know which NCI skills apply. It helps technical staff who do not write code choose, download, and set up the right skills from the NCI Skills Library, and check that their computer has the tools those skills need. Produces an installed set of skills, a tool readiness report, and a plain-English summary of what happened and what to do next.
...
1. **Announce every step before you do it, and report the result after.**
   Use the running count, for example: `Step 2 of 7: Looking up the NCI Skills
   Library.` Then afterwards: `Found 14 skills. 1 is fully reviewed, 13 are
   drafts.`
...
8. **Never claim something is done until you have confirmed it.**
9. Tone is calm and concrete. No hype. No emojis.
...
1. The requested artifact, which is:
   ...
   - A plain-English summary covering what was asked, what was installed, where
     it was put, what happens next, and what is still missing.
2. Assumptions, stated explicitly. For example: which AI assistant was detected,
   which answers were inferred rather than asked, and whether the live catalog
   or the built-in fallback list was used.
3. Risks and dependencies, including any skill that was recommended but is still
   ...
   NCI Skills Library that has no coverage for this situation, and anything that
   will block the user later.

## Workflow

Work through these seven steps in order. Announce each one before starting it.

### Step 1 of 7 — Understand your setup

Tell the user you are checking two things: which AI assistant you are running
inside, and whether the current folder already contains a project.
...
### Step 2 of 7 — Look up the library
...
### Step 3 of 7 — Ask about your project
...
### Step 4 of 7 — Choose the right skills
...
### Step 5 of 7 — Check the tools your computer needs
...
### Step 6 of 7 — Install the skills
...
### Step 7 of 7 — Summarise and hand off

Give a plain-English summary with these five headings, in this order:
...
4. **What happens next.** The single concrete action to take now, for example:
   "Start a new session and say: use the Cloud One deployment skill to set up my
   project."
5. **What is missing.** Every tool they declined, every gap in the library, and
   anything else that will block them later. If there is nothing, say so.

Then stop. Do not begin building anything. This skill sets up the work; it does
not do the work.
...
- [ ] All seven steps were announced before starting and reported after finishing
...
- [ ] The final summary covered all five headings
...
- Do not start building the user's application. Hand off at the end of Step 7.
